...
var missKim: Person = Person(name: "김영희", age: 18, gender: Person.Gender.female, money: 13000)
...
missKim.orderCoffee(Coffee.flatWhite, of: yagombucks, by: missKim.nickName)
yagombucks.checkSalesRevenue()
